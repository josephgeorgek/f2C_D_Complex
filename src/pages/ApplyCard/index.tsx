...
const ApplyCardPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gray-100_02 flex flex-col font-opensans items-center justify-start mx-auto pb-9 w-full">
        <div className="flex flex-col items-start justify-start w-auto md:w-full">
          ...
          <div className="flex flex-col gap-6 items-start justify-start md:px-10 sm:px-5 px-[156px] w-auto md:w-full">
            <div className="bg-white-A700 flex md:flex-col flex-row gap-4 items-start justify-center max-w-[1128px] mx-auto px-20 md:px-5 py-16 rounded-[12px] shadow-bs5 w-full">
              <Text
              ...
              <div className="flex md:flex-1 flex-col items-start justify-start w-auto md:w-full">
                <div className="flex flex-col gap-6 items-start justify-start w-auto md:w-full">
                      ...
                      <div className="flex flex-col gap-1 items-start justify-start w-auto">
                        <div className="flex flex-col h-[50px] md:h-auto items-start justify-start w-[279px] sm:w-full">
                          <Input
                            ...
                            className="!placeholder:text-blue_gray-800 !text-blue_gray-800 font-semibold p-0 text-base text-left uppercase w-full"
                  ...
                  <ApplyCardCardbreakdown className="bg-gray-100_7f border border-gray-300_01 border-solid flex flex-col gap-2 items-start justify-start p-6 sm:px-5 rounded-lg w-full" />
                </div>
              </div>
            </div>
            <div className="bg-white-A700 flex md:flex-col flex-row gap-4 items-start justify-start max-w-[1128px] mx-auto px-20 md:px-5 py-16 rounded-[12px] shadow-bs5 w-full">
